        ...
        <form action="">
            <div class="row pb-2 pt-2">
                <div class="d-flex">
                    ...
                    <div class="col-lg-6">
                        <a href="{{route('product.trashed')}}" class="btn btn-danger">
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{route('product.destroy',$item->id)}}" method="post">
                                <a href="{{route('product.edit',$item->id)}}" class="button-icon-update"><ion-icon name="create-outline" class="icon-delete"></ion-icon></a>
                                @method('delete')
                                @csrf
